"""HKOS Snapshot File Persistence (DS-017 ЭТАП 5).

Канонический file-backed бэкенд порта SnapshotPersistence
(hkos.snapshot.snapshot_loader.SnapshotPersistence): atomic, append-only,
plain JSON. Ранее дублировался в mcp_server/persistence.py и
scripts/doctor_cli.py — теперь единственный адрес класса.
